...
| 3. **McMillan Options** | **13.4%** | IV Rank, P/C Ratio, Max Pain, UOA, Greeks ⭐ |
...
**Weight Sum:** 19.6 + 15.2 + 13.4 + 4.5 + 4.5 + 17.9 + 5.3 + 19.6 = **100.0%** (NO normalization needed)
...
- **`analyze_technical(ticker, period="6mo", include_ml_analysis=True)`** - Comprehensive technical analysis including RSI, MACD, Bollinger Bands, EMA/VWAP confluence, volume confirmation, ML probability layer, and Al Brooks price action analysis (pattern, probability, bar reading, trap risk).
