...
### Phase 4: Options Position Management (January 2026) â­
...
1. Run stock/ETF 4-gate validation (normal flow above)
...
- âœ… **50% Profit** (IMMEDIATE) - Close at 50% of max profit (88% win rate)
- ðŸ“… **21 DTE** (WITHIN_3_DAYS) - Close/roll at 21 days to expiration
- ðŸ”„ **Direction Change** (IMMEDIATE) - Exit if Brooks flips
- âš ï¸ **Tested Position** (IMMEDIATE if DTE â‰¤ 7) - Close if price breaches strike
- ðŸ“Š **Earnings** (IMMEDIATE if < 7 days) - Close to avoid IV crush
...
| **2. FRESHNESS + DALIO** | Is it fresh? Money flowing? | Exhausted? Money reversing? | 5/6 checks pass | 4/6 checks pass | â‰¤3/6 checks pass |
...
|----------|--------|--------|--------|--------|--------|--------|
| NVDA | âœ… | âœ… | âœ… | âœ… | 4/4 STRONG | HOLD |
| AAPL | âœ… | âš ï¸ | âœ… | âœ… | 3/4 HOLD | Monitor G2 |
| TSLA | âŒ | âš ï¸ | âœ… | âš ï¸ | 2/4 TRIM | Reduce 50% |
| META | âŒ | âŒ | âŒ | âœ… | 1/4 CLOSE | Exit 75% |

**Legend:** âœ… PASS | âš ï¸ WARNING | âŒ FAIL
...
| Gate | Status | Details |
|------|--------|---------|
| **1. CATALYST** | âœ…/âš ï¸/âŒ | [Catalyst description + status] |
| **2. FRESHNESS** | âœ…/âš ï¸/âŒ | Exhaustion XX/100, CVD [aligned/diverging] |
| **3. BROOKS** | âœ…/âš ï¸/âŒ | Always-In [LONG/SHORT], Trap [LOW/MED/HIGH] |
| **4. QUALITY** | âœ…/âš ï¸/âŒ | Grade [A-F], F-Score X/9, Z-Score X.XX |

**GATE SIGNAL:** [4/4 STRONG_HOLD / 3/4 HOLD / 2/4 TRIM / 1/4 CLOSE 75% / 0/4 CLOSE]

---

#### Gate 1: Catalyst Lifecycle [detect_catalyst_strength] â­ ENHANCED (Dec 2025)
...
- Only news â‰¤3 days old counts toward score; today's news = 2x weight
- Insider selling discounted 75% if 10b5-1 pre-planned sale detected

**Catalyst Verdict:** [ACTIVE âœ… / EXHAUSTED âš ï¸ / FAILED âŒ]
...
| 4 | **Dalio Ratio** | X.XXXX | â‰¥1.0 | 0.95-1.0 | <0.95 |
| 5 | **Dollar Flow** | $XX.XXM | Positive | ~0 | Negative |
| 6 | **Sustainability** | XX/100 | â‰¥50 | 40-49 | <40 |

**Checks Passing:** X/6 (Need 5/6 to PASS)

**Dalio Exit Triggers (CRITICAL):**
- **Dalio Ratio drops below 1.0** â†’ Buyers paying less = weakening demand â†’ TRIM
- **Dollar Flow turns negative** â†’ Net distribution = institutions exiting â†’ TRIM
- **Sustainability drops below 40** â†’ Trend losing momentum = reversal risk â†’ CLOSE

**Freshness Verdict:** [FRESH âœ… (5-6/6) / TIRED âš ï¸ (4/6) / EXHAUSTED âŒ (â‰¤3/6)]
...
**Brooks Verdict:** [SUPPORTS âœ… / NEUTRAL âš ï¸ / OPPOSES âŒ]

---

#### ðŸ“š AL BROOKS EDUCATIONAL BREAKDOWN
...
âœ… **You are trading WITH the trend.** This is the RIGHT side. Your job now is to **hold until Always-In flips** or you hit target. Don't take profits too early - let winners run.

[If Always-In opposed to position]:
âŒ **You are fighting the market.** Every day you hold this is a bet that Always-In will flip in your favor. That's HOPE, not strategy. Consider **trimming or exiting** if this persists >3 days.

[If Always-In NEUTRAL]:
âš ï¸ **Market in balance.** Your position has no trend support. Either wait for Always-In to align, or exit if it flips against you.
...
[If HIGH]:
ðŸš¨ **DANGER:** This setup has **HIGH trap risk**. Signs of trap:
...
[If MEDIUM]:
âš ï¸ **CAUTION:** Not a trap yet, but watch for:
...
[If LOW]:
âœ… **SAFE:** This is a good setup with low trap risk. Market showing conviction, follow-through, and alignment. Hold with confidence.
...
[If SUPPORTS âœ…]:
ðŸ“ˆ **HOLD with conviction.** Brooks price action confirms your thesis.
...
[If NEUTRAL âš ï¸]:
âš ï¸ **HOLD but DON'T add.** Market is in balance, no edge.
...
[If OPPOSES âŒ]:
ðŸš¨ **TRIM or CLOSE.** Brooks says you're on wrong side.
...
- **â‰¤1/4 Gates:** Close position regardless of Brooks
...
| F-Score | X/9 | [Strong â‰¥7 / OK 4-6 / Weak <4] |
...
**Quality Verdict:** [STRONG âœ… / ADEQUATE âš ï¸ / DETERIORATING âŒ]
...
- If STRONG insider buying cluster â†’ Override TRIM to HOLD
- If STRONG options bearish flow â†’ Consider TRIM regardless of gates

---

#### ðŸ“š McMILLAN OPTIONS EDUCATIONAL BREAKDOWN
...
[If HIGH IV]:
ðŸ“ˆ **EXPENSIVE OPTIONS** - Premium is inflated due to uncertainty/event risk.
...
[If P/C > 1.2]:
ðŸŸ¢ **BULLISH CONTRARIAN** - Excessive put buying = fear/hedging.
...
[If P/C < 0.5]:
ðŸ”´ **BEARISH CONTRARIAN** - Excessive call buying = greed/speculation.
...
[If P/C 0.5-1.2]:
âšª **NEUTRAL** - Balanced options activity, no extreme sentiment.
...
âš ï¸ **DOWNWARD PULL** - Price may drift down toward $[XX.XX] by expiration ([X days away])
- **Action:** Consider trimming if up significantly, or wait until after expiration for upside continuation

[If current price < Max Pain]:
ðŸ“ˆ **UPWARD PULL** - Price may drift up toward $[XX.XX] by expiration
- **Action:** HOLD through expiration for potential upside drift

[If current price â‰ˆ Max Pain]:
ðŸŽ¯ **AT TARGET** - Price likely to stay range-bound until expiration
...
ðŸ’° **SELL COVERED CALLS** (Income Strategy)
...
ðŸš€ **BUY ATM CALLS** (Leverage Strategy)
...
ðŸ›¡ï¸ **BUY PROTECTIVE PUTS** (Insurance Strategy)
...
âš ï¸ **CONSIDER PROTECTIVE COLLAR**
...
#### ðŸ“Š OPTIMAL OPTIONS STRATEGY FOR POSITION (Risk-Managed)
...
### ⭐ STANDARD DEVIATION STRIKE SELECTION (MANDATORY)

**ALWAYS use standard deviation to select strikes. Never use arbitrary percentages like "5% OTM".**

#### Step 1: Calculate Expected Move

**Formula:** `1 SD Move = Current Price × IV × √(DTE / 365)`

**Pre-calculated √(DTE/365) factors:**
| DTE | √Factor | Use Case |
|-----|---------|----------|
| 7 | 0.1387 | Weekly options |
| 14 | 0.1960 | Bi-weekly |
| 30 | 0.2867 | Monthly |
| **45** | **0.3514** | **Optimal DTE** ⭐ |
| 60 | 0.4055 | 2-month |
| 90 | 0.4965 | Quarterly |

**Example Calculation:**
```
Stock: $100 | IV: 50% | DTE: 45

1 SD = $100 × 0.50 × 0.3514 = $17.57
+1 SD Upper = $100 + $17.57 = $117.57
-1 SD Lower = $100 - $17.57 = $82.43
```

#### Step 2: Standard Deviation Distribution Table

**ALWAYS populate this table for options recommendations:**

| SD Level | Formula | Probability Below | Delta Equivalent |
|----------|---------|-------------------|------------------|
| +2 SD | Current + 2×SD | 97.5% | ~5Δ |
| +1.5 SD | Current + 1.5×SD | 93% | ~10Δ |
| **+1 SD** | Current + SD | **84%** | **~16Δ** ⭐ |
| +0.5 SD | Current + 0.5×SD | 69% | ~30Δ |
| ATM | Current | 50% | ~50Δ |
| -0.5 SD | Current - 0.5×SD | 31% | ~30Δ put |
| **-1 SD** | Current - SD | **16%** | **~16Δ put** ⭐ |
| -1.5 SD | Current - 1.5×SD | 7% | ~10Δ put |
| -2 SD | Current - 2×SD | 2.5% | ~5Δ put |

#### Step 3: Institutional Strike Selection Guidelines

| Strategy | Recommended SD | Delta | Probability OTM | Risk Level |
|----------|----------------|-------|-----------------|------------|
| **Covered Call (Conservative)** | +1 SD | 16Δ | 84% | LOW ⭐ |
| Covered Call (Moderate) | +0.75 SD | 25Δ | 77% | MEDIUM |
| Covered Call (Aggressive) | +0.5 SD | 30-35Δ | 65-70% | HIGH |
| **Protective Put (Conservative)** | -1 SD | 16Δ | 84% stays above | LOW ⭐ |
| Protective Put (Aggressive) | -0.5 SD | 30Δ | 69% stays above | MEDIUM |
| **Short Put (Credit Spread)** | -1 SD | 16Δ | 84% | LOW ⭐ |
| Iron Condor Wings | ±1 SD | 16Δ each | 68% inside | STANDARD |

**⚠️ INSTITUTIONAL STANDARD: 16Δ (1 SD) for all premium selling strategies**

#### Step 4: Visual Strike Map Template

**ALWAYS include this visual in recommendations:**

```
    +2 SD:     $XXX.XX ┄┄┄┄┄┄┄┄ (97.5% below) ~5Δ
    ─────────────────────────────────────────────────
    +1.5 SD:   $XXX.XX ┄┄┄┄┄┄┄┄ (93% below) ~10Δ
    ─────────────────────────────────────────────────
    +1 SD:     $XXX.XX ━━━━━━━━ (84% below) ~16Δ ⭐ INSTITUTIONAL
    ─────────────────────────────────────────────────
    +0.5 SD:   $XXX.XX ┄┄┄┄┄┄┄┄ (69% below) ~30Δ MODERATE
    ─────────────────────────────────────────────────
    CURRENT:   $XXX.XX ═════════ (50%) ATM
    ─────────────────────────────────────────────────
    -0.5 SD:   $XXX.XX ┄┄┄┄┄┄┄┄ (31% below) ~30Δ put
    ─────────────────────────────────────────────────
    -1 SD:     $XXX.XX ━━━━━━━━ (16% below) ~16Δ put ⭐ INSTITUTIONAL
    ─────────────────────────────────────────────────
    -2 SD:     $XXX.XX ┄┄┄┄┄┄┄┄ (2.5% below) ~5Δ put
```

#### Step 5: Underlying Asset Equivalent (For ETFs)

**For ETFs tracking commodities/indices, ALWAYS calculate the underlying equivalent:**

| ETF | Underlying | Typical Ratio | Calculation |
|-----|------------|---------------|-------------|
| SLV | Silver (oz) | ~1.15x | Silver = SLV × 1.15 |
| GLD | Gold (oz/10) | ~0.093x | Gold = GLD / 0.093 |
| USO | WTI Crude | ~0.70x | Oil = USO / 0.70 |
| SPY | S&P 500 | ~10x | SPX = SPY × 10 |
| QQQ | Nasdaq 100 | ~40x | NDX = QQQ × 40 |

**Example for SLV:**
```
SLV Strike: $85 → Silver Equivalent: $85 × 1.15 = $97.75/oz
Compare to Silver Resistance Levels: $100/oz, $110/oz, $121/oz (ATH)
```
...
**IV (from options chain):** {IV}%
**DTE:** {DTE} days

#### STANDARD DEVIATION CALCULATION

```
1 SD Move = ${current_price} × {IV} × √({DTE}/365)
1 SD Move = ${current_price} × {IV} × {sqrt_factor}
1 SD Move = ${calculated_1sd}
```

#### SD PRICE LEVELS TABLE

| SD Level | Strike | % from Current | Probability OTM | Delta |
|----------|--------|----------------|-----------------|-------|
| +2 SD | ${X} | +{X}% | 97.5% | ~5Δ |
| +1.5 SD | ${X} | +{X}% | 93% | ~10Δ |
| **+1 SD** | **${X}** | **+{X}%** | **84%** | **~16Δ** ⭐ |
| +0.5 SD | ${X} | +{X}% | 69% | ~30Δ |
| ATM | ${current} | 0% | 50% | ~50Δ |
| -0.5 SD | ${X} | -{X}% | 31% | ~30Δ |
| **-1 SD** | **${X}** | **-{X}%** | **16%** | **~16Δ** ⭐ |
| -2 SD | ${X} | -{X}% | 2.5% | ~5Δ |
...
```
    +2 SD:     $XXX.XX ┄┄┄┄┄┄┄┄ (97.5% below) ~5Δ
    +1 SD:     $XXX.XX ━━━━━━━━ (84% below) ~16Δ ⭐ INSTITUTIONAL
    +0.5 SD:   $XXX.XX ┄┄┄┄┄┄┄┄ (69% below) ~30Δ
    ─────────────────────────────────────────────────
    CURRENT:   $XXX.XX ═════════ [YOUR STRIKE: +X.XX SD]
    ─────────────────────────────────────────────────
    -0.5 SD:   $XXX.XX ┄┄┄┄┄┄┄┄ (31% below) ~30Δ
    -1 SD:     $XXX.XX ━━━━━━━━ (16% below) ~16Δ ⭐ INSTITUTIONAL
    -2 SD:     $XXX.XX ┄┄┄┄┄┄┄┄ (2.5% below) ~5Δ
```

[If HIGH IV (>60%) + LONG stock]:
💰 **RECOMMENDED: Sell Covered Call at +1 SD (16Δ)**

| Field | Value |
|-------|-------|
| **Strike (+1 SD)** | **${1SD_upper}** ⭐ |
| SD Level | +1.0 SD |
| Delta | ~16Δ |
| Probability OTM | 84% |
| Expiry | 45 DTE |
| Premium | ~${X.XX}/share |
| Yield | ~X.X% for 45 days |
| Underlying Equivalent | ${X} [for ETFs] |

**Alternative Strikes Comparison:**
| Aggressiveness | Strike | SD | Delta | Premium | Prob OTM |
|----------------|--------|-----|-------|---------|----------|
| **Conservative** ⭐ | ${1SD} | +1 SD | 16Δ | ${X} | 84% |
| Moderate | ${0.75SD} | +0.75 SD | 25Δ | ${X} | 77% |
| Aggressive | ${0.5SD} | +0.5 SD | 30Δ | ${X} | 69% |

**Exit Rules:**
1. Buy back at 50% profit
2. Roll up/out if stock exceeds strike before expiry
3. Accept assignment if at/above your target price

[If LOW IV (<30%) + Want Protection]:
🛡️ **RECOMMENDED: Buy Protective Put at -1 SD (16Δ)**

| Field | Value |
|-------|-------|
| **Strike (-1 SD)** | **${1SD_lower}** ⭐ |
| SD Level | -1.0 SD |
| Delta | ~16Δ |
| Probability ITM | 16% |
| Expiry | 60-90 DTE |
| Cost | ~${X.XX}/share |
| Protection Begins | Below ${1SD_lower} |
...
### ⚠️ STRIKE SELECTION RULES (NEVER VIOLATE)

1. **ALWAYS calculate SD before recommending strikes** - No arbitrary "5% OTM" or "10% OTM"
2. **16Δ (1 SD) is the institutional standard** for premium selling strategies
3. **30Δ (0.5 SD) is the maximum aggression** for covered calls (65-70% prob OTM)
4. **ALWAYS include the visual SD map** in every options recommendation
5. **For ETFs, ALWAYS show underlying equivalent** price levels
6. **Higher IV = wider SD ranges** - strikes automatically adjust further OTM
...
| Sector Rank | #X of Y peers | [Leader â‰¤3 / Middle / Laggard] |
| RS vs Sector | XX | [Outperforming/Underperforming] |
| RS vs SPY | XX | [Leader >70 / Laggard <30] |
| Best Competitor | [TICKER] | RS: XX |

**Leadership Verdict:** [LEADER âœ… / MIDDLE âš ï¸ / LAGGARD âŒ]

**Leadership Override:**
- If LAGGARD and competitor is LEADER â†’ Consider rotation
- If LEADER falling to MIDDLE â†’ Early warning, monitor closely
...
|------------|-------|----------|-----|---------|--------|
| ðŸŸ¢ Bullish OB | $XX.XX | -X.X% | X days | +X.X% | [TESTING/NEAR/FAR] |
| ðŸ”´ Bearish OB | $XX.XX | +X.X% | X days | -X.X% | [TESTING/NEAR/FAR] |

---

### ðŸ“Š POSITION ACTION
...
```
TARGET 3:    $XX.XX â”ˆâ”ˆâ”ˆâ”ˆâ”ˆâ”ˆâ”ˆâ”ˆ (+XX%) Extension target (Fib 1.618 / Major resistance)
TARGET 2:    $XX.XX â”â”â”â”â”â”â”â” (+XX%) Measured move (Pattern target / Resistance)
TARGET 1:    $XX.XX â”â”â”â”â”â”â”â” (+X.X%) Near-term resistance (Previous high / Round number)
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
CURRENT:     $XX.XX â•â•â•â•â•â•â•â•â• (0%)
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
RAISED STOP: $XX.XX â”…â”…â”…â”…â”…â”…â”…â”… (-X.X%) Lock gains â­ [If position up >10%]
ORIG STOP:   $XX.XX â”â”â”â”â”â”â”â” (-XX%) Original risk (Swing low / 2.5x ATR)
```
...
[If 4/4 Gates]:
ðŸ’Ž **LET IT RUN** - All systems go, hold full position
...
[If 3/4 Gates]:
âš¡ **NORMAL SCALING** - One gate failing, reduce risk gradually
...
[If 2/4 Gates]:
âš ï¸ **AGGRESSIVE SCALING** - Multiple failures, prioritize capital preservation
- **T1 Hit:** Sell 50% immediately
- **T2 Hit:** Sell another 25% (75% total out)
- **Remaining:** Tiny runner (25%) with very tight stop

[If â‰¤1/4 Gates]:
ðŸš¨ **CLOSE ON ANY BOUNCE** - Setup broken, exit on strength
...
[If 4/4 gates]:
ðŸ’¡ **CONSIDER ADDING** on pullback to support
...
[If 3/4 gates]:
ðŸ“Š **HOLD CURRENT SIZE** - Don't add, don't reduce yet
- **Why:** One gate failing = uncertainty, maintain current exposure
- **Watch:** If gate recovers â†’ consider add. If second gate fails â†’ trim.
...
- If held >30 days with no progress toward T1 â†’ Re-evaluate thesis
- If catalyst passes and position doesn't move â†’ Exit (catalyst failed)
- If Always-In opposed >5 days â†’ Exit (trend against you)
...
- [ ] Size position based on gates (4/4 = full, 3/4 = 75%, 2/4 = 50%, â‰¤1/4 = close)
...
#### ðŸš¦ GATE STATUS (Simplified for ETFs)

| Gate | Status | Details |
|------|--------|---------|
| **2. FRESHNESS** | âœ…/âš ï¸/âŒ | Exhaustion XX/100 |
| **3. BROOKS** | âœ…/âš ï¸/âŒ | Always-In [LONG/SHORT] |
...
âš ï¸ **NOTE:** `analyze_options_mcmillan()` analyzes **ONE SPECIFIC EXPIRATION** (30-45 DTE optimal). If liquidity appears poor but `detect_unusual_options_activity()` shows volume, they're analyzing **DIFFERENT EXPIRATIONS**.
...
|----------|-----------|-----------|-------|
| NVDA | 4/4 | 4/4 | Stable âœ… |
| AAPL | 4/4 | 3/4 | Declining âš ï¸ |
| TSLA | 3/4 | 2/4 | Deteriorating âŒ |
...
## ðŸ”´ MANDATORY: STORE PREDICTIONS FOR POSITION CHANGES
...
|-------|------|--------|--------|
| PRE | -30 to -7 | âœ… ACTIVE | Anticipation building |
| ACTIVE | -7 to +3 | âœ… ACTIVE | Peak interest |
| POST | +3 to +30 | âš ï¸ FADING | Continuation or reversal? |
| EXHAUSTED | >+30 | âŒ FAILED | Need new catalyst |

### Gate 2: Exhaustion Thresholds

| Score | Status | Action |
|-------|--------|--------|
| 0-30 | âœ… FRESH | Strong conviction hold |
| 31-49 | âœ… OK | Normal hold |
| 50-59 | âš ï¸ TIRED | Tighten stops |
| 60-69 | âš ï¸ EXTENDED | Consider trim |
| 70-100 | âŒ EXHAUSTED | Trim or close |

### Gate 3: Al Brooks Rules

| Always-In | Position | Status |
|-----------|----------|--------|
| LONG | LONG | âœ… ALIGNED |
| SHORT | LONG | âŒ OPPOSED |
| NEUTRAL | LONG | âš ï¸ WATCH |

| Trap Risk | Action |
|-----------|--------|
| LOW | âœ… Safe to hold |
| MEDIUM | âš ï¸ Tighten stops |
| HIGH | âŒ Consider exit |

### Gate 4: Quality Grades

| Grade | Score | F-Score | Z-Score | Action |
|-------|-------|---------|---------|--------|
| A | 80-100 | 7-9 | >2.99 | âœ… Strong hold |
| B | 65-79 | 5-6 | >2.99 | âœ… Hold |
| C | 50-64 | 4-5 | 1.81-2.99 | âš ï¸ Monitor |
| D | 35-49 | 2-3 | <1.81 | âŒ Trim |
| F | 0-34 | 0-1 | <1.81 | âŒ Close |
...
|-----------|-----------------|
| STRONG insider cluster (3+ buys, $1M+) in 30 days | TRIM â†’ HOLD |
| CEO/CFO buying | +1 gate equivalent |
| STRONG bearish options flow ($500K+ puts) | HOLD â†’ TRIM |
| Heavy institutional selling (13F) | HOLD â†’ TRIM |
...
|------|-----------|-----------|
| **1** | **IV Drives Strategy** | HIGH IV â†’ SELL premium; LOW IV â†’ BUY premium |
...
| **6** | **Liquidity Rules** | Spread â‰¤5%, OI â‰¥100, Volume â‰¥50 |

---

### Phase 4: Position Management (January 2026) â­
...
|---|------|---------|--------|---------|
| 1 | âœ… **50% Profit** | P&L â‰¥ 50% max profit | CLOSE | IMMEDIATE |
| 2 | ðŸ“… **21 DTE** | DTE â‰¤ 21 days | CLOSE (profit) or ROLL (loss) | WITHIN_3_DAYS |
| 3 | ðŸ”„ **Direction Change** | Brooks Always-In flips | CLOSE | IMMEDIATE |
| 4 | âš ï¸ **Tested Position** | Price breaches strike + DTE â‰¤ 7 | CLOSE | IMMEDIATE |
| 5 | ðŸ“Š **Earnings** | Earnings < 7 days | CLOSE | IMMEDIATE |
...
```markdown
**Stock Position:** HOLD (4/4 gates pass)
**Options Position:** CLOSE (IMMEDIATE) - âœ… 50% profit target hit
...
Integrated Action: Close options immediately at 50% profit.
                   Keep stock position (4/4 gates still pass).
```
...
- âœ… ADD recommendation (new position with 4/4 gates)
- âœ… Rotation candidate (replacing TRIM/CLOSE)
- âœ… STRONG_HOLD + want to add on pullback

**DO NOT generate options trading plan for:**
- âŒ HOLD (maintain, no new entry)
- âŒ TRIM (reducing, not adding)
- âŒ CLOSE (exiting, not entering)
